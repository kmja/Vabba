...
/**
 * Who each caregiver is in this plan, at the top of the results: their
 * portrait from the wizard's scene, what they earn, what they have to spend
 * and what they are aiming for — with a way straight back to their step.
 */
export function CaregiverSummary({
  ...
  second: boolean;
  /** Cradling the bundle, for whoever is home first. */
  holding: boolean;
  babyCount: number;
  onEdit: () => void;
}) {
  ...
  return (
    <div className="bg-card flex items-stretch gap-3 rounded-lg border p-3 shadow-sm">
      <div className="aspect-[15/22] w-14 shrink-0 self-start sm:w-16">
        <CaregiverPortrait
          second={second}
          holding={holding}
          babyCount={babyCount}
